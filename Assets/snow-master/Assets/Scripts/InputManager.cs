...
namespace COMP30019.Project2
{
    public class InputManager : MonoBehaviour
    {
        ...
        float getTilt()
        {
            ...
            // Existing gyro and keyboard input handling
            ...
            {
                if (Input.GetKey(KeyCode.D) || IsTouchingRightSide())
                    direction += 1.0f;

                if (Input.GetKey(KeyCode.A) || IsTouchingLeftSide())
                    direction -= 1.0f;
            }
        ...
        // Check if there's a touch input on the right side of the screen
        ...
        // Check if there's a touch input on the left side of the screen
